...
const ContactPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(err);
      setStatusMessage('Failed to submit. Please check your connection.');
    } finally {
      setSubmitting(false);
    }
  };
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              The more details you provide about your inquiry, the better we can assist you. Don't hesitate to be specific!
            </p>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              ...
              style={{
                ...
                fontWeight: '600',
                color: 'white',
                background: submitting ? '#9CA3AF' : 'linear-gradient(135deg, #FF6B35, #F7931E)',
                border: 'none',
                borderRadius: '12px',
            ...
            {statusMessage && (
              <div style={{
                ...
                fontSize: isMobile ? '0.95rem' : '1rem',
                fontWeight: '500',
                background: statusMessage.includes('Thank') ? '#F0FDF4' : '#FEF2F2',
                color: statusMessage.includes('Thank') ? '#059669' : '#DC2626',
                border: `1px solid ${statusMessage.includes('Thank') ? '#86EFAC' : '#FCA5A5'}`,
                display: 'flex',
                alignItems: 'center',
                gap: '8px'
              }}>
